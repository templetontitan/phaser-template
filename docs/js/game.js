...
var game = new Phaser.Game(WIDTH, HEIGHT, Phaser.AUTO, 'hello-world-example', {
  preload: preload, 
  create: create, 
  update: update}
  );
function preload() {
game.load.image('background', 'assets/images/sky.png');game.load.image('bubble-img', 'assets/images/bubble.png');}
function create() {
